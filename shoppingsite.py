...
def show_shopping_cart():
    ...
    for melon_id, count in cart.items():
        print('melon ID should:', melon_id)
        melon = melons.get_by_id(melon_id)  #like random.choice because we imported melons.py
        melon.quantity = count
        total_cost = melon.price * count
